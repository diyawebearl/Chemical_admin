    ...
    rows: categoryList
      .filter(
        (item) =>
          ...
          (buyerFilter === "" || (item?.buyer_company_id?.company_name || '').toLowerCase().includes(buyerFilter.toLowerCase())) &&
          ...
          (stateFilter === "" || (item?.buyer_company_id?.state || '').toLowerCase().includes(stateFilter.toLowerCase())) &&
          (cityFilter === "" || (item?.buyer_company_id?.city || '').toLowerCase().includes(cityFilter.toLowerCase())) &&
